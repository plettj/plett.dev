...
// URL hash tab support from @KATT: https://github.com/shadcn-ui/ui/issues/414#issuecomment-1772421366
...
const TabsContext = React.createContext<Context>(null as unknown as Context);
...
export const TabsTriggerSkeleton = (props: {
  children: React.ReactNode;
  className?: string;
  active?: boolean;
}) => {
